                ...
                return (
                    ...
                    <div className="col-lg-2 col-md-10 col-xs-12 mx-auto mt-4">
                        <Card style={{ width: '24.5rem' }}>
                            <Card.Body >
                                <Card.Text>Precio: {historial.precio} €</Card.Text>
                                <Card.Text>Numero de huespedes: {historial.huespedes}</Card.Text>
                                <Card.Text>Fecha de ingreso: {historial.fecha_entrada}</Card.Text>
                                <Card.Text>Fecha de salida: {historial.fecha_salida}</Card.Text>
                                <Card.Text>Tipo de habitacion: {historial.tipo_habitacion}</Card.Text>
                            </Card.Body>
                        </Card>
